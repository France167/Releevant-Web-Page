# Releevant Web Page with Admin Panel

<b> Final project for the Bootcamp </b> <br/>
<i>New web page for Releevant, including an admin panel where you can add, update or delete, students, teachers, experts, events and candidates. </i>
